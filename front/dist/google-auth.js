...
(function() {
  ...
  GitLabLoginButtonDirective = function($window, $params, $location, $config, $events, $confirm, $auth, $navUrls, $loader) {
    var link;
    link = function($scope, $el, $attrs) {
      var auth_url, clientId, loginOnError, loginOnSuccess, loginWithGitLabAccount;
      ...
      loginOnError = function(response) {
        ...
        if (response.data._error_message) {
          ...
          return $confirm.notify("light-error", "Our Oompa Loompas have not been able to get you credentials from GitLab.");
        }
      };
  ...
  module.directive("tgGitlabLoginButton", ["$window", '$routeParams', "$tgLocation", "$tgConfig", "$tgEvents", "$tgConfirm", "$tgAuth", "$tgNavUrls", "tgLoader", GitLabLoginButtonDirective]);
    ...
    link = function($scope, $el, $attrs) {
      ...
      loginOnError = function(response) {
        ...
        if (response.data._error_message) {
          ...
          return $confirm.notify("light-error", "Error obtaining credentials from Google.");
        }
      };
